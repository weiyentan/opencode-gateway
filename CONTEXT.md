...
reappears after a terminal outcome. Terminal means that the binding cannot
transition again; a retry is a new AWX Execution Binding for a new AWX
Execution.
_Avoid_: AFK Run status

**Failure Summary**:
Bounded, redacted diagnostic metadata attached to a failed or cancelled
AWX Execution Binding. It is a short explanation of the terminal failure, not
