-- =============================================================================
-- STATIC SCHEMA REFERENCE (test-only — NOT used in production)
--
-- Alembic is the production schema source of truth.  All tables are created
-- by migrations in alembic/versions/.  This file is auto-generated from the
-- migration chain and kept for:
--   1. Quick visual reference of the current schema
--   2. Test fixtures that need a static SQL baseline
--
-- Do NOT edit this file manually.  Run the schema dump script to regenerate.
-- =============================================================================
