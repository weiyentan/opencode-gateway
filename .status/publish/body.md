...
| #727 | Measure day-index benefit on production-like data (measurement only, no code changes) |
...
- **#727**: Measurement-only task — no code changes in this diff. Index measurement methodology is documented in ADR 0017.
